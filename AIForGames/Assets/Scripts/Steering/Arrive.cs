...
public class Arrive : SteeringBase
{
    ...
    void Start()
    {
        ...
        //target = GameObject.Find("Target").gameObject.transform;
    }
    ...
    public override void GetSteeringOutput(Vector3 target)
    {
        ...
        steeringOutput.linear = (target - transform.position).normalized * maxAcceleration;
